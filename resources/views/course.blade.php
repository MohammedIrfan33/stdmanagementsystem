  ...
  <div class="w-full px-4 sm:px-8 mt-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="p-6">
        ...
        <span
          class="{{ $course['status']=='active' ? "bg-green-100 text-green-800" : "bg-gray-300 text-black-800" }} flex-shrink-0 inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold ">
