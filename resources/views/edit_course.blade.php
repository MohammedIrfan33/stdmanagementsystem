<x-layout title="Edit Course">
    <!-- Added a soft background color to the body for better contrast -->
        ...
        <div class="bg-white p-6 sm:p-8 rounded-xl shadow-lg max-w-2xl mx-auto">
          ...
          <form action="/courses/1" method="POST">
            ...
            <div class="space-y-8">
              ...
              <div>
                ...
                <div class="mt-2 relative">
                  <!-- Added an icon for better visual affordance -->
                  ...
                  <input type="text" name="course-name" id="course-name" value="{{ $course['name'] }}"
                    class="block w-full rounded-md border-0 py-2 pl-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                </div>
              </div>
              ...
              <div>
                ...
                <div class="mt-2">
                  <div class="relative rounded-md shadow-sm">
                    ...
                    <input type="text" name="fee" id="fee" value="{{ $course['fees'] }}"
                      class="block w-full rounded-md border-0 py-2 pl-7 pr-12 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                  </div>
              ...
              <div>
                ...
                <div class="mt-2">
                  <select id="status" name="status"
                    class="block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:max-w-xs sm:text-sm sm:leading-6">
            ...
            <div class="mt-10 pt-6 border-t border-gray-200 flex items-center justify-end gap-x-6">
              <button type="button" class="text-sm font-semibold leading-6 text-gray-900 hover:bg-gray-100 px-4 py-2 rounded-md transition-colors">Cancel</button>
              <button type="submit"
                class="rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition-colors">Update
                Course</button>
            </div>
          </form>
        </div>
